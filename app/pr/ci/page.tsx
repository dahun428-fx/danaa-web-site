...
const CI_SECTIONS = [
  {
    ...
    description:
      "바이오에이지의 워드마크는 C와 I, O를 유기적으로 연결해 첨단성과 신뢰감, 그리고 고객과의 끊임없는 소통을 표현합니다. 모든 응용 매체에서 비례와 색상을 임의로 변경하지 말고 원본 데이터를 사용해 주세요.",
  },
  {
    title: "로고타입",
    image: "/resources/images/sub/sub_0503_img_02.jpg",
    description:
      "로고타입은 워드마크와 조합해 바이오에이지의 브랜드 이미지를 전달하는 핵심 요소입니다. 가로나 세로 형태 등 제공된 규격을 그대로 활용하며, 서체 변경이나 변형을 금지합니다.",
  },
  {
    title: "시그니처",
